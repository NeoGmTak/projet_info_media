                        ...
                        <div class="row row-page1">
                            <div class="col-xs-4 vignette vignette_red">
                                <a href="#" id="monument-link">
                                    <img src="images/icones/church.png" alt="Sites et monuments" class="img-responsive">
                                    <h3>Sites & Monuments</h3>
                                </a>
                            </div>
                            <div class="col-xs-4 vignette vignette_black">
                                <a href="#" id="museum-link">
                                    <img src="images/icones/museum.png" alt="Musées" class="img-responsive">
                                    <h3>Musées</h3>
                                </a>
                            </div>
                            <div class="col-xs-4 vignette vignette_red">
                                <a href="#" id="trip-link">
                                    <img src="images/icones/map.png" alt="Visites guidées" class="img-responsive">
                ...
                <div class="container clearfix">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p>Impossible considered invitation him men instrument saw celebrated unpleasant. Put rest
                                and must set kind next many near nay. He exquisite continued explained middleton am.
                                Voice hours young woody has she think equal. Estate moment he at on wonder at season
                                little. Six garden result summer set family esteem nay estate. End admiration mrs
                                unreserved discovered comparison especially invitation. </p>
                            <p>Delightful unreserved impossible few estimating men favourable see entreaties. She
                                propriety immediate was improving. He or entrance humoured likewise moderate. Much nor
                                game son say feel. Fat make met can must form into gate. Me we offending prevailed
                                discovery. </p>
                        </div>
                        <div class="col-md-5 col-md-offset-1">
                            <p><img src="images/about.jpg" alt="" class="img-responsive img-circle"></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container clearfix">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="box"><a href="#" title=""><img src="images/portfolio-1.jpg" alt=""
                                                                               class="img-responsive"></a></div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="box"><a href="#" title=""><img src="images/portfolio-2.jpg" alt=""
                                                                               class="img-responsive"></a></div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="box"><a href="#" title=""><img src="images/portfolio-3.jpg" alt=""
                                                                               class="img-responsive"></a></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="box"><a href="#" title=""><img src="images/portfolio-4.jpg" alt=""
                                                                               class="img-responsive"></a></div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="box"><a href="#" title=""><img src="images/portfolio-5.jpg" alt=""
                                                                               class="img-responsive"></a></div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="box"><a href="#" title=""><img src="images/portfolio-6.jpg" alt=""
                                                                               class="img-responsive"></a></div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container clearfix">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <p>Able an hope of body. Any nay shyness article matters own removal nothing his
                                    ...
                                    <p>Betrayed cheerful declared end and. Questions we additions is extremely
                                        ...
                                        few. Had admitting concluded too behaviour him she. Of death to or to being
                                        other. </p>
                                </div>
                                <div class="col-sm-6">
                                    <p>Effects present letters inquiry no an removed or friends. Desire behind latter me
                                        though in. Supposing shameless am he engrossed up additions. My possible
                                        peculiar together to. Desire so better am cannot he up before points. Remember
                                        mistaken opinions it pleasure of debating. Court front maids forty if aware
                                        their at. Chicken use are pressed removed. </p>
                                    <p>Saw yet kindness too replying whatever marianne. Old sentiments resolution
                                        ...
                                        on easy. Form not calm new fail. </p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p>Able an hope of body. Any nay shyness article matters own removal nothing his
                                        ...
                                        happy. Without farther she exposed saw man led. Along on happy could cease green
                                        oh. </p>
                                    <p class="social"><a href="#" title="" class="facebook"><i
                                                    class="fa fa-facebook"></i></a><a href="#" title="" class="twitter"><i
                                                    class="fa fa-twitter"></i></a><a href="#" title="" class="gplus"><i
                                                    class="fa fa-google-plus"></i></a><a href="#" title=""
                                                                                         class="instagram"><i
                                                    class="fa fa-instagram"></i></a><a href="#" title=""
                                                                                       class="email"><i
                            ...
                            <div class="row copyright">
                                ...
                                <div class="col-md-6">
                                    <p class="credit">Code by <a href="https://bootstrapious.com/portfolio-themes">Bootstrapious</a>
                                    </p>
